...
<a name='L592'></a><a href='#L592'>592</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >      case responseType.COUNT:</span>
<span class="cstat-no" title="statement not covered" >        this._path = `/${this._resource.getListResourcePath()}/\$count?${this._resource.urlQuery()}`;</span>
...
&nbsp;
  ...
  payload(payload) {
    if (!_.isPlainObject(payload)) {
      throw new Error("Entity payload is not plain object.");
    }
&nbsp;
