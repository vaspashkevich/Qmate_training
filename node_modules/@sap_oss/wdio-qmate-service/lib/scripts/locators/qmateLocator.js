...
module.exports = {
    ui5All: function ui5All(ui5Selector, index, opt_parentElement) {
        ...
        function getControlBindingContextPaths(oControl) {
            if (!oControl)
                return null;
            var bindingContexts = jQuery.extend({}, oControl.oPropagatedProperties && oControl.oPropagatedProperties.oBindingContexts, oControl.oBindingContexts, oControl.mElementBindingContexts);
