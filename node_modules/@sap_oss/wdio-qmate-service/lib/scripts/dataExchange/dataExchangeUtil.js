...
class DataExchangeUtil {
     ...
     */
    async readData(fileOrDir, params) {
     ...
     */
    async readFolder(folder, params) {
        ...
        for (const file of files) {
            if (file.isDirectory()) {
                ...
                await this.readFolder(path_1.default.resolve(folder, file.name), [...params, file.name]);
            }
            else if (file.isFile()) {
     ...
     * @param {string[]} params - the keys hierarchy under which data should be stored
     */
    async readFile(filename, params) {
        try {
