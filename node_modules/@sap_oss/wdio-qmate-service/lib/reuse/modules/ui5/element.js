...
class ElementModule {
     ...
     */
    async waitForAll(selector, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async getDisplayed(selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async getByText(selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async getByChild(elementSelector, childSelector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
        const vl = this.vlf.initLog(this.getByText);
        const selector = {
     ...
     */
    async getByParent(elementSelector, parentSelector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async getId(selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async getPropertyValue(selector, property, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async getValue(selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async getBindingValue(selector, bindingContext, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async isVisible(selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
