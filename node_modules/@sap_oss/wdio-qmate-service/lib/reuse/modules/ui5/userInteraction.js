...
class UserInteraction {
     ...
     */
    async check(selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async uncheck(selector, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
     ...
     */
    async selectFromTab(selector, value, index = 0, timeout = process.env.QMATE_CUSTOM_TIMEOUT || 30000) {
